...
#Route de base : verfier que l'API fonctionne
@app.get("/health")
def health_check():
    return {
        "status": "ok",
...
def predict(patient: PatientInput):
    ...
    messages = {
        "palu":
        "Suspicion de paludisme. Consultez un medecin rapidement.",
        "grippe":
        "Suspicion de grippe. Repos et hydratation recommandes.",
        "typh":
        "Suspicion de typhoide. Consultation medicale necessaire.",
        "sain":
        "Pas de pathologie detectee. Continuez a surveiller."
    }
